...
const Header = ({ toggleTheme, isLoggedIn, setIsLoggedIn }) => {
      ...
      <div className="container">
        <div className="header__left">
          <Link to={urlPages.mainPath}>
            ...
            <div className="header__shopName">
              <h2 className="header__title">
                React Bookstore / Maksym Maksymenko
              </h2>
            </div>
          </Link>
        </div>
        <div className="header__right">
          {isLoggedIn ? (
            <div className="header__user">
              <Basket value={Object.keys(booksPurchase).length || 0} />
          ...
          <button className="header__btn" type="button" onClick={toggleTheme}>
            {theme === 'light' ? (
              <svg
